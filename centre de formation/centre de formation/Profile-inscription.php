...
<div class="row profileLinksSection  text-center">
    ...
    <div class=" profileLinksdiv col-md-6">    <a href="Profile-inscription.php" class="profileLinks" style="text-decoration: underline;color : blue;">Courses in progress</a>
    </div>
    
    <div class=" profileLinksdiv col-md-6">    <a href="Profile-formation-passee.php" class="profileLinks" style="color : blue;">Past courses</a>
    </div>
...
echo '</table>';
    ...
    <h1 class ="text-center">No courses available</h1>
  </div>';
}

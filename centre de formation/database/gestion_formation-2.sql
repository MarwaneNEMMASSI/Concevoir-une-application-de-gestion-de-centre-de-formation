...
--
-- Host: localhost
-- Generation Time: May 17, 2023 at 12:07 AM
...
(3, '2023-05-17', '2023-05-31', 3, 'annulée', 1, 1),
...
(8, '2023-06-01', '2023-06-30', 20, 'en cours d\'inscription', 2, 2),
(9, '2023-06-05', '2023-06-25', 20, 'en cours d\'inscription', 4, 2);
...
--
ALTER TABLE `session`
  MODIFY `id_session` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
